...
namespace Ameko.Controls
{
    ...
    public class SeekSlider : RangeBase
    {
        ...
        static SeekSlider()
        {
            ...
            ValueProperty.OverrideMetadata<SeekSlider>(new(enableDataValidation: true));
            AutomationProperties.ControlTypeOverrideProperty.OverrideDefaultValue<SeekSlider>(AutomationControlType.Slider);
        }
        ...
        {
            _isDragging = false;
            if (DragEnded != null) DragEnded(this, new EventArgs());
        }
